...
//BNB MAIN Bridge
import CreedBNBBridgeAddress from "../../contractsData/CreedBridgeBase-address.json";
import CreedBNBBridge from "../../contractsData/CreedBridgeBase.json";

//ETHEREUM BRIDGE
import WrappedETHTokenAddress from "../../contractsData/WrappedCreedEthereum-address.json"; //ETHEREUM WrappedCreed
import WrappedETHToken from "../../contractsData/WrappedCreedToken.json"; //ETHEREUM WrappedCreed

import WrappedETHBridgeAddress from "../../contractsData/WrapedBridgeEthereum-address.json"; //ETHEREUM WrappedBridge
import WrappedETHBridge from "../../contractsData/WrapedBridgeBase.json"; //ETHEREUM WrappedBridge

//Polygon
import WrappedPolygonTokenAddress from "../../contractsData/WrappedCreedPolygon-address.json"; //Polygon WrappedCreed
import WrappedPolygonBridgeAddress from "../../contractsData/WrapedBridgePolygon-address.json"; //Polygon WrappedBridge

//Tron
import WrappedTronTokenAddress from "../../contractsData/WrappedCreedTron-address.json"; //Tron WrappedCreed
import WrappedTronBridgeAddress from "../../contractsData/WrapedBridgeTron-address.json"; //Tron WrappedBridge
